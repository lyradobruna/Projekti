...
function gardenia_entry_meta() {
	...
	<div class="fancy_categories">
            <div class="glyphicon glyphicon-user color"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="tag"><?php echo esc_html(get_the_author()); ?></a></div>
           ...
           <?php if(is_single()): if(!empty($gardenia_tag_list)) { ?><div class="glyphicon glyphicon-tag color"><?php echo wp_kses_post($gardenia_tag_list); ?></div><?php } ?>
           <?php if(!empty($gardenia_categories_list)) { ?><div class="glyphicon glyphicon-folder-open color"><?php echo wp_kses_post($gardenia_categories_list); ?></div><?php } ?>
