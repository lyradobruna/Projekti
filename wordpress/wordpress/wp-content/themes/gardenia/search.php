...
<section class="blog-bg">
    ...
    <div class="webpage-container container">
      <div class="gg_menu clearfix">
		  <div class="col-md-6 col-sm-6">          
			<h1><?php esc_html_e('Search Results for ','gardenia'); echo ": ".get_search_query(); ?></h1>	               
		  </div>
		  <div class="col-md-6 col-sm-6">  
  ...
  <div class="container">
	...
	<?php endwhile; 
		 ...
		 <div class="blog-content">
			 <h3><?php esc_html_e('Nothing Found','gardenia'); ?></h3>
			<p><?php esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.','gardenia'); ?></p>
			<div class="col-md-4">
				<?php get_search_form(); ?>  
			</div>
		 </div>
